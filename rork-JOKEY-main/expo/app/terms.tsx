  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      ...
      <View style={styles.iconSection}>
        ...
        <Text style={styles.lastUpdated}>{t('terms.lastUpdated')}: 2026-03-01</Text>
      </View>

      <View style={styles.section}>
        <Text style={styles.sectionTitle}>{t('terms.acceptTitle')}</Text>
        <Text style={styles.sectionText}>{t('terms.acceptText')}</Text>
      </View>

      <View style={styles.section}>
        <Text style={styles.sectionTitle}>{t('terms.accountTitle')}</Text>
        <Text style={styles.sectionText}>{t('terms.accountText')}</Text>
      </View>

      <View style={styles.section}>
        <Text style={styles.sectionTitle}>{t('terms.contentTitle')}</Text>
        <Text style={styles.sectionText}>{t('terms.contentText')}</Text>
      </View>

      <View style={styles.section}>
        <Text style={styles.sectionTitle}>{t('terms.conductTitle')}</Text>
        <Text style={styles.sectionText}>{t('terms.conductText')}</Text>
      </View>
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.sectionText}>{t('terms.liabilityText')}</Text>
      </View>
    </ScrollView>
  );
}
